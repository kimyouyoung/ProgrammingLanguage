...
(app (fun 'b (openbox (id 'b))) (newbox (num 7)))
f: (fun 'b (openbox (id 'b)))
a: (newbox (num 7))
f-value: (clouserV 'b (openbox (id 'b)) (mtSub))
f-store: (mtSto)
a-value: (boxV 1)
a-store: (aSto 1 (exprV (num 7) (mtSub) (mtSto) '#&#f) (mtSto))
(interp (openbox (id 'b)) (aSub 'b 2 (mtSub)) (aSto 2 (boxV 1) (aSto 1 (exprV (num 7) (mtSub) (mtSto) '#&#f) (mtSto))))
openbox
(interp (id 'b) (aSub 'b 2 (mtSub)) (aSto 2 (boxV 1) (aSto 1 (exprV (num 7) (mtSub) (mtSto) '#&#f) (mtSto))))
(v*s (boxV 1) (aSto 2 (boxV 1) (aSto 1 (exprV (num 7) (mtSub) (mtSto) '#&#f) (mtSto))))
(v*s 
